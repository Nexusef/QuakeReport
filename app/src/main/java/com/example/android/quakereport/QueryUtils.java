...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            // Create root JSON object and the JSONArray that contains earthquake features
            JSONObject root = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray features = root.optJSONArray("features");

            // Loop through each feature and extract data
            for (int i = 0; i < features.length(); i++) {

                // Focus on the first feature within features array
                JSONObject feature = (JSONObject) features.get(i);

                // Create JSON Object of feature's properties
